...
@section('sub_heading', 'Edit Permission')
@section('page_tools')
...
@section('content')
    <div class=" bg-white shadow p-4">
        <form method="POST" class="form" action="{{ route('admin.permissions.update', $permission->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="input-group mb-2">
                ...
                <input type="text" name="name" class="form-control  @error('name') is-invalid @enderror "
                    placeholder="Permission" value="{{ $permission->name }}" autocomplete="off">
                @error('name')
